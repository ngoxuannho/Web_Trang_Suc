...
function Footer() {
    ...
    return (
        <div className="flex justify-center  w-full h-96   position: absolute mt-6">
            <img
            ...
            />
            <div className=" flex justify-center gap-11  position: absolute top-10 text-white ">
                <div className="">
                    <h1 className="text-lg antialiased">Về Cửa Hàng</h1>
                    <h1 className="mt-4 text-sm">
                        Trang sức Hoàng gia - Chuyên cung cấp trang sức cao cấp sang
                        <a>trọng toàn quốc</a>
                    </h1>

                    <h1 className="flex gap-3 text-sm mt-6 ">
                        <svg
                    ...
                    <h1 className="flex gap-3 mt-4 text-sm">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                    ...
                    <h1 className="flex mt-4 gap-3 text-sm">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
